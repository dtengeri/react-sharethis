...
},{"react":159,"react-dom":2,"react-sharethis":3}],2:[function(require,module,exports){
'use strict';
...
var ShareThisButton = React.createClass({displayName: "ShareThisButton",
  propTypes: {
  ...
  render: function render() {
    ...
    return (
      React.createElement("span", {className: classes.join(' '), ref: "button"})
    );
  },
});
